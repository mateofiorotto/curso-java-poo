...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Sin embargo, este fanático también desarrolló una serie de interfaces para 
        ...
        .A  partir  de  estas  interfaces,  el  Pokefanático  desea  crear  las  clasesque  manejen  a  los personajes  principales  del  
        ...
        Pókemon  mostrando  un  mensaje  en  pantalla  que indique qué pókemon es y qué ataque está realizando, por ejemplo:
